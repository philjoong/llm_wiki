...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::graph_sqlite::graph_sqlite_ping,
            commands::graph_sqlite::graph_sqlite_create,
            commands::graph_sqlite::graph_sqlite_delete,
            commands::graph_sqlite::graph_sqlite_list,
            commands::graph_sqlite::graph_sqlite_upsert_triples,
            commands::graph_sqlite::graph_sqlite_query,
            commands::graph_sqlite::graph_sqlite_export,
            commands::graph_sqlite::graph_sqlite_import,
            commands::graph_sqlite::graph_sqlite_rename_relation_type,
            commands::graph_sqlite::graph_sqlite_delete_relation_type,
            commands::graph_sqlite::graph_sqlite_delete_node,
            commands::graph_sqlite::graph_sqlite_delete_edge,
            commands::graph_sqlite::graph_sqlite_update_node_name,
            commands::graph_sqlite::graph_sqlite_update_edge,
            commands::graph_sqlite::graph_sqlite_add_edge,
            commands::graph_sqlite::graph_sqlite_add_node,
            commands::graph_sqlite::graph_sqlite_delete_edges_by_page_path,
