...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git_ops::git_show_file,
            ...
            commands::git_ops::git_sync_commit,
            commands::git_ops::git_pull_rebase,
            commands::git_ops::git_rebase_continue,
            commands::git_ops::git_rebase_abort,
            ...
            knowledge::commands::bootstrap_knowledge_db,
            knowledge::commands::get_knowledge_db_status,
            knowledge::commands::upsert_page_document,
            knowledge::commands::create_or_link_entity,
            knowledge::commands::register_graph,
            knowledge::commands::rename_knowledge_graph,
            knowledge::commands::delete_knowledge_graph,
            knowledge::commands::list_knowledge_graphs,
            knowledge::commands::register_relation_type,
            knowledge::commands::list_knowledge_relation_types,
            knowledge::commands::rename_knowledge_relation_type,
            knowledge::commands::delete_knowledge_relation_type,
            knowledge::commands::create_assertion_with_evidence,
            knowledge::commands::create_manual_assertion,
            knowledge::commands::edit_knowledge_assertion,
            knowledge::commands::resolve_cardinality_conflict,
            knowledge::commands::delete_page,
            knowledge::commands::run_knowledge_integrity_check,
            knowledge::commands::get_knowledge_page,
            knowledge::commands::list_knowledge_pages,
            knowledge::commands::get_knowledge_section,
            knowledge::commands::find_knowledge_entities,
            knowledge::commands::list_knowledge_entities,
            knowledge::commands::rename_knowledge_entity,
            knowledge::commands::add_knowledge_entity_alias,
            knowledge::commands::remove_knowledge_entity_alias,
            knowledge::commands::merge_knowledge_entities,
            knowledge::commands::suggest_entity_merges,
            knowledge::commands::split_knowledge_entity,
            knowledge::commands::delete_knowledge_entity,
            knowledge::commands::get_knowledge_graph_snapshot,
            knowledge::commands::get_entity_neighborhood,
            knowledge::commands::list_graphs_for_page,
            knowledge::commands::create_or_link_graph_node,
            knowledge::commands::list_allowed_relation_types,
            knowledge::commands::get_knowledge_delete_impact,
